#pragma once
#ifndef SDU_CONTROLLERS_ADMITTANCE_CONTROLLER_CARTESIAN_HPP
#define SDU_CONTROLLERS_ADMITTANCE_CONTROLLER_CARTESIAN_HPP
...
namespace sdu_controllers::controllers
{
   ...
   */
  class AdmittanceControllerCartesian : public Controller
  {
   public:
    /**
     * @brief
     ...
     */
    explicit AdmittanceControllerCartesian(double frequency=500.0);
     ...
     */
    void step(const Eigen::Vector3d &input_force, const Eigen::Vector3d &input_torque);
    ...
    //
    Eigen::VectorXd get_position_output(const Eigen::Vector3d &x_desired, const Eigen::Vector4d &quat_desired);

    //
    Eigen::VectorXd get_velocity_output(const Eigen::Vector3d &xd_desired, const Eigen::Vector4d &quat_desired, const Eigen::Vector3d &omega_desired);
   ...
   private:
    ...
    // Control variables
    double dt_;
    Eigen::VectorXd u_pos{7};
    Eigen::VectorXd u_vel{6};
...
#endif  // SDU_CONTROLLERS_ADMITTANCE_CONTROLLER_CARTESIAN_HPP
