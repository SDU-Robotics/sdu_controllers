...
namespace sdu_controllers
{
  nb::module_ create_kinematics_module(nb::module_ &main_module)
  {
    ...
    nb::class_<kinematics::DHParam>(m, "DHParam", "Denavit-Hartenberg parameters for a single link")
        ...
        .def_rw("is_joint_revolute", &kinematics::DHParam::is_joint_revolute, 
                "True if joint is revolute, false if prismatic");

    // Bind ForwardKinematics base class
    nb::class_<kinematics::ForwardKinematics>(m, "ForwardKinematics", 
                                               "Base class for forward kinematics implementations")
        .def("forward_kinematics", &kinematics::ForwardKinematics::forward_kinematics,
             nb::arg("q"),
        ...
        .def("forward_kinematics_all", &kinematics::ForwardKinematics::forward_kinematics_all,
             nb::arg("q"),
        ...
        .def("get_joint_types", &kinematics::ForwardKinematics::get_joint_types,
        ...
        .def("geometric_jacobian",
             ...
             "Returns:\n"
             "    6xDOF geometric Jacobian matrix")
        .def("get_dof", &kinematics::ForwardKinematics::get_dof,
             "Get the degrees of freedom of the kinematic chain\n\n"
             "Returns:\n"
             "    Number of degrees of freedom");

    // Bind DHKinematics class
    nb::class_<kinematics::DHKinematics, kinematics::ForwardKinematics>(m, "DHKinematics",
                                                                         "Forward kinematics using Denavit-Hartenberg parameters")
        .def(nb::init<>(), "Default constructor")
        .def(nb::init<const std::vector<kinematics::DHParam>&>(),
        ...
        .def(nb::init<const std::vector<double>&, const std::vector<double>&, const std::vector<double>&,
             ...
             nb::arg("a"), nb::arg("alpha"), nb::arg("d"), nb::arg("theta"), nb::arg("is_joint_revolute"),
        ...
        .def(nb::init<const Eigen::VectorXd&, const Eigen::VectorXd&, const Eigen::VectorXd&,
             ...
             "    is_joint_revolute: Vector indicating if each joint is revolute (True) or prismatic (False)")
        .def("get_a", &kinematics::DHKinematics::get_a,
             "Get the link length parameters\n\n"
             "Returns:\n"
             "    List of link lengths")
        .def("get_alpha", &kinematics::DHKinematics::get_alpha,
             "Get the link twist parameters\n\n"
             "Returns:\n"
             "    List of link twists")
        .def("get_d", &kinematics::DHKinematics::get_d,
             "Get the link offset parameters\n\n"
             "Returns:\n"
             "    List of link offsets")
        .def("get_theta", &kinematics::DHKinematics::get_theta,
